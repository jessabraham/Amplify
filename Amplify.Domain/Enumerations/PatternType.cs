...
public enum PatternType
{
    ...
    TweezerTop = 206,
    TweezerBottom = 207,
    BullishHaramiCross = 208,
    BearishHaramiCross = 209,
    BullishKicking = 210,
    BearishKicking = 211,
    BullishMeetingLines = 212,
    BearishMeetingLines = 213,
    HomingPigeon = 214,
    MatchingLow = 215,
    LastEngulfingBottom = 216,
    LastEngulfingTop = 217,
    BullishDojiStar = 218,
    BearishDojiStar = 219,
    InNeck = 220,
    OnNeck = 221,
    ...
    EveningDojiStar = 308,
    ThreeOutsideUp = 309,
    ThreeOutsideDown = 310,
    AdvanceBlock = 311,
    Deliberation = 312,
    IdenticalThreeCrows = 313,
    ThreeStarsInSouth = 314,
    StickSandwich = 315,
    UpsideTasukiGap = 316,
    DownsideTasukiGap = 317,
    RisingThreeMethods = 318,
    FallingThreeMethods = 319,
    BullishThreeLineStrike = 320,
    BearishThreeLineStrike = 321,
